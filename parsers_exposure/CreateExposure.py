...
file_location = 'example-data.xlsx'        

# ------------------------------
# Example using 3 variables
# ------------------------------
nickname = 'Example-EPN2'  # to add to the saved file
...
## ------------------------------
#nickname = 'Example 2 variables'  # to add to the saved file
#num_var = 'two' # Number of variables in the data (small letter)
#exaple_2 = classes.ReadCensus(nickname, file_location, num_var)
#
#mapping_sheet = 'mapping_2var' # name or location of mapping matrix
#exaple_2.mapping_matrix(mapping_sheet, row_var1=2, print_vars=False)
#
#parse_sheets = 'Level1_2var' # name or location of sheet to parse (example: 0 or 'Sheet1')
#admin_level = 1     # administrative level to be analised (optional) (free text)
#save_folder_name = 'example_2vars' #folder name to save parsed data
