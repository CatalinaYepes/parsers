...
file_location = '/Users/catalinayepes/Desktop/ejemplo_exposure/ejemplo.xlsx'        

## ------------------------------
## Example using 3 variables
## ------------------------------
#nickname = 'Example 3 variables'  # to add to the saved file
#num_var = 'three' # Number of variables in the data (small letter)
#ex_3vars = classes.ReadCensus(nickname, file_location, num_var)
#
#mapping_sheet = 'mapping_3var' # name or location of mapping matrix
#ex_3vars.mapping_matrix(mapping_sheet, row_var1=2, row_var3=12, print_vars=True)
#
#parse_sheets = 1 # name or location of sheet to parse (example: 0 or 'Sheet1')
#admin_level = 3  # administrative level to be analised (optional) (free text)
#save_folder_name = 'example_3vars' # folder name to save parsed data
#ex_3vars.parse_info(parse_sheets, admin_level, save_folder_name, save_regions=True, save_data=True)


# ------------------------------
# Example using 2 variables
# ------------------------------
nickname = 'Quito'  # to add to the saved file
num_var = 'two' # Number of variables in the data (small letter)
exaple_2 = classes.ReadCensus(nickname, file_location, num_var)

mapping_sheet = -1 # name or location of mapping matrix
exaple_2.mapping_matrix(mapping_sheet, row_var1=2, print_vars=False)

parse_sheets = 2 # name or location of sheet to parse (example: 0 or 'Sheet1')
admin_level = 1     # administrative level to be analised (optional) (free text)
save_folder_name = 'modelo_Quito' #folder name to save parsed data
exaple_2.parse_info(parse_sheets, admin_level, save_folder_name, save_regions=True, save_data=True)


## ------------------------------
## Example using 1 variable
## ------------------------------
#nickname = 'Example 1 variable'  # to add to the saved file
#num_var = 'one' # Number of variables in the data (small letter)
#single_var = classes.ReadCensus(nickname, file_location, num_var)
#
#mapping_sheet = 'mapping_1var' # name or location of mapping matrix
